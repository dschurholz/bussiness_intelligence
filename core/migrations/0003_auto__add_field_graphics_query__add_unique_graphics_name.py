...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Graphics.query'
        db.add_column(u'core_graphics', 'query',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding unique constraint on 'Graphics', fields ['name']
        db.create_unique(u'core_graphics', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Graphics', fields ['name']
        db.delete_unique(u'core_graphics', ['name'])

        # Deleting field 'Graphics.query'
        db.delete_column(u'core_graphics', 'query')
