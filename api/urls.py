...
v1_urlpatterns = patterns('',
    ...
    url(r'^graphics/create/?$',
        views.CreateGraphic.as_view(),
        name='graphics-create'),
    url(r'^graphics/(?P<id>(\d+))/query/?$',
        views.GraphicQuery.as_view(),
        name='graphics-query'),
    url(r'^graphics/(?P<id>(\d+))/drilldown/?$',
        views.GraphicDrilldown.as_view(),
        name='graphics-drilldown'),
